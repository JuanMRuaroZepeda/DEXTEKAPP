...
const CMETareas = ({ navigation }) => {
  ...
  useEffect(() => {
    Promise.all([
      fetch('http://192.168.100.115:3000/api/auth/proyectos').then(response => response.json()),
      fetch('http://192.168.100.115:3000/api/auth/status').then(response => response.json()),
      fetch('http://192.168.100.115:3000/api/auth/usuarios2').then(response => response.json()),
      fetch('http://192.168.100.115:3000/api/auth/clientes').then(response => response.json()),
      fetch('http://192.168.100.115:3000/api/auth/tareas').then(response => response.json()),
    ])
  ...
  const onRefresh = () => {
    ...
    Promise.all([
      fetch('http://192.168.100.115:3000/api/auth/proyectos').then(response => response.json()),
      fetch('http://192.168.100.115:3000/api/auth/status').then(response => response.json()),
      fetch('http://192.168.100.115:3000/api/auth/usuarios').then(response => response.json()),
      fetch('http://192.168.100.115:3000/api/auth/clientes').then(response => response.json()),
      fetch('http://192.168.100.115:3000/api/auth/tareas').then(response => response.json()),
    ])
      .then(([proyectosData, statusData, usuariosData, clientesData, tareasData]) => {
  ...
  const deleteTask = (taskId) => {
    fetch(`http://192.168.100.115:3000/api/auth/eliminartarea/${taskId}`, {
      method: 'DELETE'
    })
